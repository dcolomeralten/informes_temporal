# -*- coding: utf-8 -*-
#
# Copyright (c) 2021, David Colomer - Alten - TTECH
# All rights reserved.
#

from reports.informe_personalizado_1.entrypoint import generate


def test_informe_personalizado_1(progress, client_factory, response_factory):
    """
